...
std::pair<double, double> Curve::second_derivative(double t, double h) {
    ...
    Point P = (-1/560.*point(t - 4*h) + 8/315.*point(t - 3*h) - 1/5.*point(t - 2*h) + 8/5.*point(t - h) - 205/72.*point(t)
        + 8/5.*point(t + h) - 1/5.*point(t + 2*h) + 8/315.*point(t + 3*h) - 1/560.*point(t + 4*h)) / h / h;
